# -*- coding: utf-8 -*-
# based on https://www.binpress.com/building-text-editor-pyqt-1/
...
class Main(QtWidgets.QMainWindow):
    ...
    def __init__(self,parent=None):
        ...
        # changing the background color to yellow - added by GSB
#        self.setStyleSheet("background-color: #FFFFF3;")
    ...
    def initToolbar(self):
        ...
        # status bar tips removed by GSB and floating tooltips expanded
        self.newAction = QtWidgets.QAction(QtGui.QIcon("icons/new.png"),"New document",self)
        ...
        self.previewAction = QtWidgets.QAction(QtGui.QIcon("icons/preview.png"),"Page preview",self)
        ...
        wordCountAction = QtWidgets.QAction(QtGui.QIcon("icons/count.png"),"Word/symbol count",self)
    ...
    def initFormatbar(self):
        ...
        # added by GSB to attempt to preselect a font in the menu - does not actually select font
        # helvetica is 99 
        fontBox.setCurrentIndex(99)        
        ...
        boldAction.setShortcut("Ctrl+B") # added by gsb, maps to cmd B on Mac
        boldAction.triggered.connect(self.bold)

        italicAction = QtWidgets.QAction(QtGui.QIcon("icons/italic.png"),"Italic",self)
        italicAction.setShortcut("Ctrl+I") # added by gsb, maps to cmd I on Mac
        italicAction.triggered.connect(self.italic)

        underlAction = QtWidgets.QAction(QtGui.QIcon("icons/underline.png"),"Underline",self)
        underlAction.setShortcut("Ctrl+U") # added by gsb, maps to cmd U on Mac
    ...
    def initUI(self):
        # modified by GSB only to paste unformatted text and have pale yellow background
        self.text = QtWidgets.QTextEdit(self, acceptRichText=False)
        self.text.setStyleSheet("background-color: #FFFFF5; font-family: Helvetica;")
        ...
        self.setWindowTitle("GilesWriter")
    ...
    def save(self):
        ...
        if self.filename:
            ...
            self.changesSaved = True
            self.statusbar.showMessage("Saved " + self.filename) # -------------added by gsb
    ...
    def cursorPosition(self):
        ...
        # added by gsb taken from wordcount.py
        text = self.text.toPlainText()
        words = str(len(text.split()))

        self.statusbar.showMessage("File: {}        Line {} | Column {}       {} words".format(fname,line,col,words)) # gsb added filename and word count
